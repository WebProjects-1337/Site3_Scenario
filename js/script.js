...
document.addEventListener("DOMContentLoaded", function () {
    var swiper = new Swiper(".swiper-container", {
        slidesPerView: 5, // Keep exactly 5 slides visible
        centeredSlides: true, // Keep the middle slide centered
        loop: true, // Infinite loop
        spaceBetween: -80, // Overlaps slides slightly
        autoplay: {
            delay: 4000, // Smooth auto rotation
            ...
            slideChangeTransitionEnd: function () {
                ...
                if (activeSlide.previousElementSibling) {
                    ...
                    if (activeSlide.previousElementSibling.previousElementSibling) {
                        activeSlide.previousElementSibling.previousElementSibling.classList.add("swiper-slide-prev-prev");
                    }
                }
                if (activeSlide.nextElementSibling) {
                    activeSlide.nextElementSibling.classList.add("swiper-slide-next");
                    if (activeSlide.nextElementSibling.nextElementSibling) {
                        activeSlide.nextElementSibling.nextElementSibling.classList.add("swiper-slide-next-next");
                    }
                }
            },
        },
